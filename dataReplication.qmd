...
inD <- ggplot(data = IO, mapping = aes(x = Season, y = In , fill = Sex)) +
  geom_boxplot() +
  ylab(label = "In-Degree") +
  ggtitle("In-Degree")
outD <- ggplot(data = IO, mapping = aes(x = Season, y = Out, fill = Sex)) +
  geom_boxplot() +
  ylab(label = "Out-Degree") +
  ggtitle("Out-Degree")
inS <- ggplot(data = strength, mapping = aes(x = Season, y = In , fill = Sex)) +
  geom_boxplot() +
  ylab(label = "In-Strength") +
  ggtitle("In-Strength")
outS <- ggplot(data = strength, mapping = aes(x = Season, y = Out , fill = Sex)) +
  geom_boxplot() +
  ylab(label = "Out-Degree") +
  ggtitle("Out-Degree")
eigen <- ggplot(data = EC, mapping = aes(x = Season, y = EC.vector , fill = Sex)) +
  geom_boxplot() +
  ylab(label = "Eigenvector Score") +
  ggtitle("Eigenector Centrality")
clust <- ggplot(data = CC, mapping = aes(x = Season, y = CC , fill = Sex)) +
  geom_boxplot() +
  ylab(label = "Clustering Coefficient") +
  ggtitle("Clustering Coefficient")
between <- ggplot(data = b, mapping = aes(x = Season, y = bt , fill = Sex)) +
  geom_boxplot() +
...
p <- nodePermSex(IO, n = 1000, formula = In ~ (1|ID) + (1|Season) + Sex)
...
p <- nodePermSex(IO, n = 1000, formula = Out ~ (1|ID) + (1|Season) + Sex)
...
p <- nodePermSex(strength, n = 1000, formula = In ~ (1|ID) + (1|Season) + Sex)
inSp <- mean(abs(p$perm_est) >= abs(est))

outS_sex <- lmer(Out ~ (1|ID) + (1|Season) + Sex,
                 data = strength)
summary(outS_sex)
est <- fixef(outS_sex)["SexM"]
p <- nodePermSex(strength, n = 1000, formula = Out ~ (1|ID) + (1|Season) + Sex)
...
p <- nodePermSex(EC, n = 1000, formula = EC.vector ~ (1|ID) + (1|Season) + Sex)
...
p <- nodePermGlmmSex(b, n = 1000, formula = bt ~ (1|ID) + (1|Season) + Sex)
...
p <- nodePermSex(CC, n = 1000, formula = CC ~ (1|ID) + (1|Season) + Sex)
...
p <- nodePermRank(ioFemales, n = 1000, formula = In ~ (1|ID) + (1|Season) + rank)
...
p <- nodePermRank(ioFemales, n = 1000, formula = Out ~ (1|ID) + (1|Season) + rank)
...
p <- nodePermRank(strengthF, n = 1000, formula = In ~ (1|ID) + (1|Season) + rank)
...
p <- nodePermRank(strengthF, n = 1000, formula = Out ~ (1|ID) + (1|Season) + rank)
...
p <- nodePermRank(ecFemales, n = 1000, formula = EC.vector ~ (1|ID) + (1|Season) + rank)
...
p <- nodePermGlmmRank(bFemales, n = 1000, formula = bt ~ (1|ID) + (1|Season) + (1|observation.id) + rank)
...
p <- nodePermRank(CC_Females, n = 1000, formula = CC ~ (1|ID) + (1|Season) + rank)
...
p <- nodePermRank(ioMales, n = 1000, formula = In ~ (1|ID) + (1|Season) + rank)
...
p <- nodePermRank(ioMales, n = 1000, formula = Out ~ (1|ID) + (1|Season) + rank)
...
p <- nodePermRank(strengthM, n = 1000, formula = In ~ (1|ID) + (1|Season) + rank)
...
p <- nodePermRank(strengthM, n = 1000, formula = Out ~ (1|ID) + (1|Season) + rank)
...
p <- nodePermRank(ecMales, n = 1000, formula = EC.vector ~ (1|ID) + (1|Season) + rank)
...
p <- nodePermGlmmRank(bMales, n = 1000, formula = bt ~ (1|ID) + (1|Season) + (1|observation.id) + rank)
...
p <- nodePermRank(CC_Males, n = 1000, formula = CC ~ (1|ID) + (1|Season) + rank)
